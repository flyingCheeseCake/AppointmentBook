...
public class Main {
    public static void main(String[] args) throws IOException {
        ...
        for (int i = 15; i < 30; i++) schedule[1][i] = false;
        for (int i = 0; i < 10; i++) schedule[1][i] = false;
        for (int i = 30; i < 45; i++) schedule[1][i] = true;
        for (int i = 45; i < 50; i++) schedule[1][i] = false;
        for (int i = 50; i < 60; i++) schedule[1][i] = false;
        a.printPeriod(2);
